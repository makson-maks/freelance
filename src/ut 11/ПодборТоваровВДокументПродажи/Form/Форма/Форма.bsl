...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	/////////////////////////////////////////////////////////////////////
	// Заполнение параметров обработки из документа
	Для Каждого ЭлементОбъектыНазначения Из Параметры.ОбъектыНазначения Цикл
		Параметры.Документ = ЭлементОбъектыНазначения;
		Прервать;
	КонецЦикла;
	
	Параметры.Валюта = Параметры.Документ.Валюта;
	/////////////////////////////////////////////////////////////////////
	
	/////////////////////////////////////////////////////////////////////
	// Заполним таблицу товаров из документа
	Для каждого СтрокаТоваров Из Параметры.Документ.Товары Цикл
	...
	СписокНоменклатура.Параметры.УстановитьЗначениеПараметра("ИП_1", Справочники.Организации.НайтиПоРеквизиту("ИНН", "771401697419"));
	СписокНоменклатура.Параметры.УстановитьЗначениеПараметра("ИП_2", Справочники.Организации.НайтиПоРеквизиту("ИНН", "771506834101"));
	...
	Элементы.СписокРасширенныйПоискНоменклатураСвободныйОстаток_ИП.Видимость = Истина;
	Элементы.СписокСтандартныйПоискНоменклатураСвободныйОстаток_ИП.Видимость = Истина;
...
Процедура ПриЗакрытии()
	...
	Если АдресТоваровВХранилище <> Неопределено Тогда
		...
		ОповеститьОбИзменении(Параметры.Документ);
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	Если Не ПраваПользователяПовтИсп.ЭтоПартнер() Тогда
		...
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = '<набор>'"));
