...
Процедура ВывестиСчетФактуруВТабличныйДокумент(ТабДокумент, Макет, ДанныеДляПечати)
	...
	//&_Галимов_Начало 05.09.2017 16:18:38
	ОбластьМакета.Параметры.ПредставлениеГрузоотправителя = ОбластьМакета.Параметры.АдресПоставщика;
	//&_Галимов_Конец 05.09.2017 16:18:39 
